...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    ghost = make_city('ghost', lat, lon)
    return get_name(city_a) if distance(ghost, city_a) < distance(ghost, city_b) \
...
def sprout_leaves(t, leaves):
    ...
    return tree(label(t), [sprout_leaves(ch, leaves) for ch in branches(t)])
